...
## 👩‍💻 Teknik Analisis
Teknik analisis yang digunakan mulai dari pembuatan *query* menggunakan GoogleBigQuery sehingga dapat melakukan *subset* data yang dibutuhkan untuk keperluan analisis. Setelah itu, dapat melakukan visualisasi dari hasil *query* menggunakan Google Looker Studio.

## 📝 Proses Analisis
### 1. Menggunakan GoogleBigQuery
Teknik analisis yang digunakan adalah mulai dari pembuatan *project* di GoogleBigQuery dengan nama **"Rakamin KF Analytics"**, dengan dilanjutkan untuk membuat *dataset* dengan nama **"kimia_farma"** sehingga menghasilkan tampilan sebagai berikut.
